...
import com.mos.service.IUserService;
import com.mos.util.UUIDUtil;
...
public class UserController {
	...
	@ResponseBody
	public JSONObject uploadHeadImg(@RequestParam(value="file",required=false) MultipartFile file,
