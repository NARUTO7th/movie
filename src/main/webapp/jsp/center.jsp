...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/center.css">
       ...
       function initCard(){
        ...
        function initInformation(){
            ...
            if(user.user_headImg == null || typeof user.user_headImg == "undefined"){
                HeadImg = "${pageContext.request.contextPath}/upload/head/demo.jpg";
            }else{
