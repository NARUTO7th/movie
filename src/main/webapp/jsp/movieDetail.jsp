    ...
    <script>
        ...
        function intitActor(){
            ...
            $.ajax({
                ...
                success:function (obj) {
                    console.log(obj);
                    PictureUrl = "${pageContext.request.contextPath}/static/images/actor/" + obj.data.movie_cn_name + "/director/" + obj.data.movie_director + ".jpg";
                    // 导演
                    ...
                    for(var i = 0;i<StrActor.length;i++){
                        ...
                        PictureUrl = "${pageContext.request.contextPath}/static/images/actor/" + obj.data.movie_cn_name + "/actor/" + StrRole[0] + ".jpg";
                        // 演员
                        PosName="&nbsp";
                        if(i==0){
                            PosName = "演职人员";
