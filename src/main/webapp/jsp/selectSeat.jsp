...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/buyTickets.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/movieDetail.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/selectSeat.css">
        ...
        function initBanner(){
            ...
            $.ajax({
                ...
                success:function (obj) {
                    ...
                    avatarShadow.append(
                        "<img class=\"avatar\" src=\"${pageContext.request.contextPath}/static/images/cinemas/" + obj.data[0].schedule_hall.hall_cinema.cinema_name + ".jpg\">" +
            ...
            for(var i=0;i<5;i++){
                movieList.append(
                    "<div class=\"movie active\" data-index=\"0\">" +
                        "<img src=\"${pageContext.request.contextPath}/static/images/stills/" + obj.data[0].schedule_movie.movie_cn_name + "/" + (i+1) + ".jpg\" alt=\"\">" +
                    "</div>"
                );
            }
