...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/main2.css">
    ...
    <div class="main">
        <div class="main-inner main-page">
            <div class="layui-carousel" id="test3" lay-filter="test4">
                <div carousel-item="">
                    <div>
                        <img src="${pageContext.request.contextPath}/static/images/pic1.jpg">
                    </div>
                    <div>
                        <img src="${pageContext.request.contextPath}/static/images/pic2.jpg">
                    </div>
                    <div>
                        <img src="${pageContext.request.contextPath}/static/images/pic3.jpg">
                    </div>
                    <div>
                        <img src="${pageContext.request.contextPath}/static/images/pic4.jpg">
                    </div>
                    <div>
                        <img src="${pageContext.request.contextPath}/static/images/pic5.jpg">
                    </div>
                </div>
            </div> 
            <div class="aside">
            ...
            <div class="movie-grid">
                ...
                <div class="panel-header">
                    <span class="panel-more">
                        <a href="${pageContext.request.contextPath}/jsp/movieList.jsp" class="textcolor_red" data-act="all-playingMovie-click">
                            <span>全部</span>
                        </a>
                ...
                <div class="panel">
                    <span class="panel-more">
                        <a href="${pageContext.request.contextPath}/jsp/movieList.jsp" class="textcolor_red" data-act="all-upcomingMovie-click">
                            <span>全部</span>
                        </a>
